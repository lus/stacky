...
// endGetStackHosts handles the GET '/stacks/{name}/hosts' endpoint
func endGetStackHosts(ctx *fasthttp.RequestCtx) {
	// Retrieve the stack
	...
	ctx.SetBody(successResponse(fasthttp.StatusOK, "", stack.Hosts))
}
